<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FrmTipoUsuario.aspx.cs" Inherits="Capa_Presentacion.FrmTipoUsuario" %>
...
<body>
    <form id="frmTipoUsuario" runat="server" style="margin: auto; text-align: center; width: 90%; max-width: 650px; padding: 0px;">
        <h1>Tipos de Usuarios</h1>
            <asp:HiddenField ID="hfTipoUserId" runat="server"/>
            <table id="tbl" border="0">
                <tr>
                    <td><asp:Label ID="lblTipo" runat="server" Text="Descripción " Font-Bold="true" ForeColor="white" /></td>
                    <td colspan="3"><asp:TextBox ID="txtTipo" runat="server" CssClass="txtTabla"></asp:TextBox></td>
                </tr>
            ...
            <br />
         <div id="container">
            <asp:GridView ID="GrvTipoUsuario" runat="server" AutoGenerateColumns="false" GridLines="None"
                AllowPaging="true" CssClass="mGrid" PagerStyle-CssClass="pgr" AlternatingRowStyle-CssClass="alt"
                PageSize="7"
                >
                <Columns>
                    <asp:BoundField DataField="tipu_nombre" HeaderText="Tipo dee Usuario"/>
                    <asp:TemplateField>
                        <ItemTemplate>
                       <asp:LinkButton ID="linkVer" runat="server" OnClick="LinkVer_Click" CommandArgument='<%# Eval("tipu_id")%>' CssClass="lnkGrid">&nbsp;&nbsp;&nbsp;Rellenar Campos&nbsp;&nbsp;&nbsp;</asp:LinkButton>
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
            </asp:GridView>
