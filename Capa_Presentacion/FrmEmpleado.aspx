<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FrmEmpleado.aspx.cs" Inherits="Capa_Presentacion.FrmEmpleado" %>
     ...
     <form id="frmEmpleado" runat="server" style="margin: auto; text-align: center; width: 280%; max-width: 900px; padding: 0px;">
        <h1>Empleados</h1>
            <table id="tbl" border="0">
                 <tr>
                    <td><asp:Label ID="lblCedula" runat="server" Text="Cedula " Font-Bold="true" ForeColor="White" /></td>
                    <td colspan="3"><asp:TextBox ID="txtCedula" runat="server" CssClass="txtTabla"></asp:TextBox></td>
                </tr>
                <tr>
                    <td><asp:Label ID="lblNombre1" runat="server" Text="Primer Nombre " Font-Bold="true" ForeColor="White" /></td>
                    <td colspan="3"><asp:TextBox ID="txtNombre1" runat="server" CssClass="txtTabla"></asp:TextBox></td>
                </tr>
                <tr>
                    <td><asp:Label ID="lblNombre2" runat="server" Text="Segundo Nombre " Font-Bold="true" ForeColor="White" /></td>
                    <td colspan="3"><asp:TextBox ID="txtNombre2" runat="server" CssClass="txtTabla"></asp:TextBox></td>
                </tr>
                <tr>
                    <td><asp:Label ID="lblApellido1" runat="server" Text="Primer Apellido " Font-Bold="true" ForeColor="White" /></td>
                    <td colspan="3"><asp:TextBox ID="txtApellido1" runat="server" CssClass="txtTabla"></asp:TextBox></td>
                </tr>
                <tr>
                    <td><asp:Label ID="lblApellido2" runat="server" Text="Segundo Apellido " Font-Bold="true" ForeColor="White" /></td>
                ...
                <tr>
                    <td><asp:Label ID="lblCorreo" runat="server" Text="Correo " Font-Bold="true" ForeColor="White" /></td>
                    <td colspan="3"><asp:TextBox ID="txtCorreo" runat="server" CssClass="txtTabla"></asp:TextBox></td>
                </tr>
                 <tr>
                    <td><asp:Label ID="lblDepartamento" runat="server" Text="Departamento " Font-Bold="true" ForeColor="White" /></td>
                    <td colspan="3"><asp:DropDownList ID="ddlDepartamento" runat="server" /></td>
                </tr>
                <tr>
                    <td><asp:Label ID="lblCargo" runat="server" Text="Cargo " Font-Bold="true" ForeColor="White" /></td>
         ...
         <div id="containerEmp">
            <asp:GridView ID="GrvEmpleado" runat="server" AutoGenerateColumns="false" GridLines="None"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="______________________">
                        <ItemTemplate>
                       <asp:LinkButton ID="linkVer" runat="server" OnClick="LinkVer_Click" CommandArgument='<%# Eval("per_cedula")%>' CssClass="lnkGrid">&nbsp;&nbsp;&nbsp;Rellenar Datos&nbsp;&nbsp;&nbsp;</asp:LinkButton>
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
            </asp:GridView>
