<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FrmUsuario.aspx.cs" Inherits="Capa_Presentacion.FrmUsuario" %>
...
<body>
     <form id="frmUsuario" runat="server" style="margin: auto; text-align: center; width: 90%; max-width: 650px; padding: 0px;">
        <h1>Usuarios</h1>
            <table id="tbl" border="0">
                <tr>
                    <td><asp:Label ID="lblCedula" runat="server" Text="Cédula " Font-Bold="true" ForeColor="white" /></td>
                    <td colspan="3"><asp:TextBox ID="txtCedula" runat="server" CssClass="txtTabla"></asp:TextBox></td>
                </tr>
                <tr>
                    <td><asp:Label ID="lblUsuario" runat="server" Text="Usuario " Font-Bold="true" ForeColor="white" /></td>
                    <td colspan="3"><asp:TextBox ID="txtUsuario" runat="server" CssClass="txtTabla"></asp:TextBox></td>
                </tr>
                <tr>
                    <td><asp:Label ID="lblClave" runat="server" Text="Clave " Font-Bold="true" ForeColor="white" /></td>
                    <td colspan="3"><asp:TextBox ID="txtClave" runat="server" CssClass="txtTabla"></asp:TextBox></td>
                </tr>
                <tr>
                    <td><asp:Label ID="lblTipo" runat="server" Text="Tipo de Usuario " Font-Bold="true" ForeColor="white" /></td>
         ...
         <div id="container">
            <asp:GridView ID="GrvUsuario" runat="server" AutoGenerateColumns="false" GridLines="None"
                ...
                >
                <Columns>
                    <asp:BoundField DataField="per_cedula" HeaderText="CEDULA"/>
                    ...
                    <asp:BoundField DataField="tipu_nombre" HeaderText="ROL" />
                    <asp:TemplateField>
                        <ItemTemplate>
          ...
          <asp:Button ID="btnVolver" runat="server" Text="Menu Princiaal" Height="40px" OnClick="BtnVolver_Click" CssClass="btnTabla"/>
    </form>
</body>
</html>
